...
### Vista Word en previsualización integrada
La visualización de archivos Word en la pestaña integrada usa **docx2pdf** para convertir temporalmente a PDF y mostrarlo con el mismo visor interno.
